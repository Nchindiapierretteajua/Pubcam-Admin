...
import { updateExam, fetchExams } from "@/lib/redux/features/examsSlice"
...
export default function EditExamPage({ params }: EditExamPageProps) {
  ...
  useEffect(() => {
    ...
    if (foundExam) {
      ...
      reset({
        name: foundExam.name,
        fullName: foundExam.fullName,
        description: foundExam.description,
        startDate: foundExam.startDate,
        endDate: foundExam.endDate,
        registrationStartDate: foundExam.registrationStartDate,
        registrationEndDate: foundExam.registrationEndDate,
        fees: foundExam.fees,
        eligibility: foundExam.eligibility,
        subjects: foundExam.subjects,
        venues: foundExam.venues,
        documentUrl: foundExam.documentUrl || "",
        resultDate: foundExam.resultDate || "",
        organizingBody: foundExam.organizingBody,
        imageUrl: foundExam.imageUrl || "",
        level: foundExam.level,
      })
    }
  }, [exams, params.id, reset])
  ...
  const onSubmit = async (data: ExamFormValues) => {
    ...
    try {
      ...
      await dispatch(updateExam({ id: params.id, examData: cleanedData }))
      toast({
        title: "Success",
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Update the basic details of the examination</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Select
                  value={watch("level")}
                  onValueChange={(value) => setValue("level", value as "primary" | "secondary" | "tertiary")}
                >
                  <SelectTrigger>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Update the examination and registration dates</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Update who can take this examination</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Update the subjects included in this examination</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Update the locations where this examination will be conducted</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
