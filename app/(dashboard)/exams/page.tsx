      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage available exams in Cameroon
          </p>
        </div>
        <Button asChild>
          <Link href="/exams/new">
      ...
      <Tabs defaultValue="SECONDARY" className="space-y-4">
        <TabsList>
          <TabsTrigger value="SECONDARY">
            Secondary ({groupedExams.SECONDARY.length})
          </TabsTrigger>
          <TabsTrigger value="PRIMARY">
            Primary ({groupedExams.PRIMARY.length})
          </TabsTrigger>
          <TabsTrigger value="TERTIARY">
            Higher ({groupedExams.TERTIARY.length})
          </TabsTrigger>
        </TabsList>
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span>
                          ...
                          {exam.venues.length > 2 &&
                            ` +${exam.venues.length - 2} more`}
                        </span>
                      </div>
                    </div>
